...
const Navbar = () => {
  ...
  return (
    <div>
      <div className="flex items-center justify-between p-8 bg-[#044E83] w-full h-[80px] fixed z-10">
        <Image
                ...
                <ul className="absolute right-8 mt-4 w-[350px] bg-white shadow-lg z-10">
                  <li>
                    ...
                    <div className="px-5 pb-4">
                      ...
                      <div>
                        <div className="mb-3">
                          <h1 className=" mt-5 font-bold text-[22px]">
                            Advanced Courses
                          </h1>
                          <Link
                            className="hover:text-[#044E83]"
                            href={"/Webandmetaverse"}
                          >
                            Web3 and Metaverse
                          </Link>
                        </div>
                        ...
                        <div className="mb-3">
                          <Link
                            className="hover:text-[#044E83] text-[15px]"
                            href={"/Artificialint"}
                          >
